...
const StudentInfoForm = () => {
    return (
        ...
        >
            <div className="relative z-10 mt-20 justify-center bg-white shadow-lg border-b-2 border-blue-200 w-full max-w-5xl   rounded-md p-8">
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <input
                        type="text"
                        placeholder="Physical Deformity"
                        className="border p-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                    <input
                        type="text"
                        placeholder="Major IIIness "

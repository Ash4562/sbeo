...
const teacherNames = [
    { name: "MAYA VERNEKAR" },
    { name: "PRAJAKTI DESHPANDE" },
    { name: "RUPALI NAMDE" },
    { name: "YOGITA SURYAVANSHI" },
    { name: "DEEPALI TAYADE" },
    { name: "PALLAVI DHURVE" },
    { name: "AARTI KULKARNI" },
    { name: "VANDANA PATIL" },
...
const NameCards = () => {
    ...
    return (
        ...
        <div className="flex items-center justify-center gap-4 my-14">
                <div className="sm:w-40 w-14 border-t-2 border-blue-500"></div>
                <h3 className="sm:text-xl font-semibold text-gray-800 uppercase font-playfair">
                    Pre-primary Teachers
                </h3>
                <div className="sm:w-40 w-14 border-t-2 border-blue-500"></div>
            </div>
            <div className="mt-10 bg-blue-100 flex items-center justify-center p-4">
